...
namespace Server.API.Migrations
{
    ...
    [Migration("20201016102228_removemeassures")]
    partial class removemeassures
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.API.OrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Server.API.OrderLine", b =>
                {
                    b.HasOne("Server.API.Models.Order")
                        .WithMany("OrderLines")
                        .HasForeignKey("OrderId");
                });
