...
namespace Server.API.Migrations
{
    ...
    [Migration("20200823123313_AddSinglePhotoToUser3")]
    partial class AddSinglePhotoToUser3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.API.Models.User", b =>
                {
                    b.HasOne("Server.API.Models.Photo", "Photo")
                        .WithOne("User")
                        .HasForeignKey("Server.API.Models.User", "PhotoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
